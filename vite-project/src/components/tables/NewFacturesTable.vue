            ...
            <v-col class="d-flex flex-column ga-4">
                ...
                >
                    ...
                    >
                        <tr>
                            ...
                            <td>
                                {{
                                    factures
                                        .map(f => (f.tva ? ((f.tjm * f.nbJours) * 1.2) : (f.tjm * f.nbJours)))
                                        .reduce((acc, curr) => acc + curr, 0)
                                        .toFixed(2)
                                }} €
                            </td>
                    ...
                    <template #item.montantHt="{ item }">
                        {{ (item.tjm * item.nbJours).toFixed(2) }} €
                    </template>
                    ...
                    <template #item.montantTTC="{ item }">
                        {{ item.tva ? ((item.tjm * item.nbJours) * 1.2).toFixed(2) : (item.tjm * item.nbJours).toFixed(2) }} €
                    </template>
...
<script setup lang="ts">
    ...
    import NewStatutChip from '../chips/NewStatutChip.vue';
